...
class SearchInput(pyx.Component):
    ...
    def updateParams(self, params):
        ...
        print(123)
        xs = pyx.pyx_factory.createElement("button", {'ref': self.submit, 'renderWorker': TextRenderWorker()}, "Submit", )
        container.appendChild( xs, _relayout=False )
        print(123)
        container.renderNode.reflow().renderWorker.update()
