...
class Toggle(pyx.Component):
    ...
    def body(self):
        return pyx.pyx_factory.createElement("div", {'class': 'container'}, "", pyx.pyx_factory.createElement("text", {'class': 'option', 'ref': self.activeItem},  self.props['items'][0]   , ), "",  *(  pyx.pyx_factory.createElement("text", {'class': 'option'},  i   , )  for i in self.props['items'][1:]) , "", )
