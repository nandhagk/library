...
class Add(pyx.Component):
    ...
    def body(self):
        return pyx.pyx_factory.createElement("div", {'class': 'container'}, "", pyx.pyx_factory.createElement(Toggle, {'searchFilter': self.addFilter, 'items': ['Loans', 'Books', 'Tags', 'People']}), "", pyx.pyx_factory.createElement(SearchInput, {'ref': self.searchInput, 'submit': self.add, 'submitText': "Add", 'expect': self.getParams()}), "", )
